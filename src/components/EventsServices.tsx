...
const eventServices: EventType[] = [{
  ...
  features: ["Customized menu planning", "Elegant presentation", "Professional service staff", "Complete setup and cleanup"]
}, {
  id: "2",
  ...
  features: ["Breakfast and lunch options", "Executive dining experiences", "Team building cooking events", "Drop-off catering available"]
}, {
  id: "3",
  ...
  features: ["Theme-based menu options", "Special dietary accommodations", "Dessert stations and cake service", "Bartending services"]
}, {
  id: "4",
  ...
  features: ["Traditional recipe preparation", "Authentic ingredients sourcing", "Cultural presentation styles", "Festival-specific menus"]
}];
  ...
  return <section id="services" className="section-padding bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="section-subtitle mx-auto">From gatherings to grand celebrations, we serve to all types of events with our exceptional culinary services.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
          {eventServices.map(event => <div key={event.id} className="bg-softcream rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all group">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-2 mb-6">
                  {event.features.map((feature, index) => <li key={index} className="flex items-center text-gray-700">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-burgundy mr-2">
                        <path d="M20 6 9 17l-5-5" />
                      </svg>
                      {feature}
                    </li>)}
                </ul>
                <Button className="w-full btn-outline" onClick={onBookNowClick}>
                  Book This Service
                </Button>
              </div>
            </div>)}
        ...
        <div className="bg-burgundy/10 rounded-2xl p-8 md:p-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Button className="mt-8 btn-primary" onClick={onBookNowClick}>
                Get Custom Quote
              </Button>
            </div>
            <div className="hidden md:block">
              <img src="https://images.unsplash.com/photo-1625937286074-9ca519f7f6e4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" alt="Additional services" className="rounded-lg shadow-lg" />
            </div>
          </div>
        </div>
      </div>
