    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {/* Company Info */}
          <div>
            <h3 className="text-2xl font-serif font-bold mb-6">Rebekha Caters</h3>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@rebekha.com" className="text-gray-300 hover:text-white transition-colors">
                  info@rebekha.com
                </a>
              </li>
            </ul>
        ...
        <div className="text-center text-gray-400">
          <p>© {currentYear} Rebekha Caters. All Rights Reserved.</p>
